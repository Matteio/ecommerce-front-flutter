...
class CartManager{
  ...
  Future<String> _makeRequest(String serverAddress, String servicePath, String method, TypeHeaderCart? type, {Map<String, String>? value, dynamic body}) async {
    print("uri: ");
    ...
    while ( true ) {
      try {
        ...
        if ( type == TypeHeaderCart.json ) {
          contentType = "application/json;charset=utf-8";
          formattedBody = json.encode(body);
        }
        else if ( type == TypeHeaderCart.urlencoded ) {
  ...
  Future<String> makePostRequest(String serverAddress, String servicePath, {dynamic value, TypeHeaderCart type = TypeHeaderCart.json, Map<String,String>? params}) async {
    print("MakePostRequest");
    return _makeRequest(serverAddress, servicePath, "post", type, body: value);
  }

  Future<String> makeGetRequest(String serverAddress, String servicePath, [Map<String, String>? value, TypeHeaderCart? type]) async {
  ...
  Future<String> makePutRequest(String serverAddress, String servicePath, [Map<String, String>? value, TypeHeaderCart? type]) async {
    return _makeRequest(serverAddress, servicePath, "put", type, value: value);
  }

  Future<String> makeDeleteRequest(String serverAddress, String servicePath, [Map<String, String>? value, TypeHeaderCart? type]) async {
